...
const page = () => {
    ...
    //     loop: false,
    //     autoplay: true,
    //     animationData: require('/ticket.json'),
    //   });
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    <h2 className="sm:text-5xl text-2xl text-gradient font-medium title-font mb-2 md:w-2/5">Buy your tickets now!</h2>
    <div className="md:w-3/5 md:pl-6">
      ...
      {/* <div className={`flex-1 flex md:my-0 my-10 relative`} ref={containerRef}/> */}
...
<div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
        <input type="text" placeholder="Search for events" className="flex w-full font-epilogue font-normal text-[14px] placeholder:text-[#4b5264] text-white bg-transparent outline-none" />
        
                  <div className="w-[72px] h-full rounded-[20px] bg-[#8A42D8] flex justify-center items-center cursor-pointer">
          <Image height={15} width={15} src='/search.svg' alt="search" className=" object-contain"/>
        </div> 
      </div>
      <section className="mt-12 text-gray-600 body-font m-[100px]">
